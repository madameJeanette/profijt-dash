  ...
  return (
    <main className="bg-white min-h-screen p-12">
      ...
      <img className="mx-auto" src={image1} alt="green book"/>
        <h1 className="text-5xl flex justify-center">Groen</h1>
        <h2 className="text-lg text-gray-600 flex justify-center mb-12">Welkom op de lesmateriaal pagina van profiel Groen</h2>
