...
import image1 from '../img/oBook.jpg'
export default function Gr() {
 const [postData, setPost] = useState(null);

 useEffect(() => {
   sanityClient
    .fetch(`*[_type == "post" && 'burgerschap' in tags]{
      title,
      slug,
      tags,
      mainImage{
  ...
  return (
    <main className="bg-white min-h-screen p-12">
      ...
      <img className="mx-auto" src={image1} alt="green book"/>
        <h1 className="text-5xl flex justify-center">Burgerschap</h1>
        <h2 className="text-lg text-gray-600 flex justify-center mb-12">Welkom op de lesmateriaal pagina van Burgerschap</h2>
